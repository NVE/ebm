...
def extract_area_forecast(years: YearRange, scurve_parameters: pd.DataFrame, tek_parameters: pd.DataFrame, area_parameters: pd.DataFrame, database_manager:DatabaseManager):
    ...
    s_curves = transform_scurve_parameters_to_scurve(scurve_parameters)
    df_never_share = transform_scurve_parameters_never_share(s_curves, scurve_parameters)
    ...
    s_curve_cumulative_demolition = calculate_s_curve_cumulative_demolition(cumulative_demolition, years)
    s_curve_demolition = calculate_s_curve_demolition(cumulative_demolition, years)
    s_curve_renovation_never_share = calculate_s_curve_renovation_never_share(s_curves_with_tek, years)
    s_curve_small_measure_never_share = calculate_s_curve_small_measure_never_share(s_curves_with_tek, years)
    s_curve_cumulative_small_measure = calculate_s_curve_cumulative_small_measure(s_curves_with_tek, years)
    s_curve_cumulative_renovation = calculate_s_curve_cumulative_renovation(s_curves_with_tek, years)

    s_curve_renovation_max = calculate_s_curve_renovation_max(s_curve_cumulative_demolition, s_curve_renovation_never_share)
    ...
    s_curve_renovation_total = trim_scurve_max_value(s_curve_cumulative_renovation, s_curve_renovation_max)

    scurve_total = calculate_s_curve_total(s_curve_renovation_total, s_curve_small_measure_total)

    s_curve_renovation = calculate_s_curve_renovation_from_small_measure(s_curve_renovation_max, s_curve_small_measure_total)
    ...
    s_curve_small_measure = calculate_s_curve_small_measure(s_curve_renovation_and_small_measure, s_curve_small_measure_total)

    s_curve_original_condition = calculate_s_curve_original_condition(s_curve_cumulative_demolition, s_curve_renovation,
