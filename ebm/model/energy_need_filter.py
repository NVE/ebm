...
def filter_original_condition(df, building_category, tek, purpose):
    ...
    deduped = deduped.drop_duplicates(['building_category', 'TEK', 'purpose'])
    return deduped[(deduped.building_category==building_category) & (deduped.TEK==tek) & (deduped.purpose == purpose)]
