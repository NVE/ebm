...
def small_measure(s_curve_renovation_and_small_measure, s_curve_small_measure_total):
...
def renovation_and_small_measure(s_curve_renovation, s_curve_renovation_total):
...
def trim_renovation_from_renovation_total(s_curve_renovation, s_curve_renovation_max, s_curve_renovation_total,
                                          scurve_total):
...
def renovation_from_small_measure(s_curve_renovation_max, s_curve_small_measure_total):
...
def scurve_parameters_to_never_share(s_curves, scurve_parameters):
...
def scurve_parameters_to_scurve(scurve_parameters):
