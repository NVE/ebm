...
from ebm.model.bema_validation import validate_rush_rates, validate_scurves, validate_shares, validate_area
...
def main():
    ...
    arg_parser.add_argument('--validate', type=str, choices=['rush_rates', 'scurves', 'shares', 'area', '*'], nargs='?', default='*')
